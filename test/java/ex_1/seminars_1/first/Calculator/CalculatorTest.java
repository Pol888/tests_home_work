package ex_1.seminars_1.first.Calculator;

import ex_1.seminars_1.first.Calculator.Calculator.*;
...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(-8.56, 4)
        ).isInstanceOf(ArithmeticException.class);

        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(8.56, -1)
        ).isInstanceOf(ArithmeticException.class);

        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(8.56, 101)
        ).isInstanceOf(ArithmeticException.class);
